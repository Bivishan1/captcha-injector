...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const imageElement = document.querySelector("#captchaImg");
  ...
  imageElement.onload = imageElement.onerror = function () {
    ...
    // Get the base64 data of the image from the canvas
    const base64Data = canvas.toDataURL("image/jpeg"); // You can also use "image/png" for PNG images
    ...
    Tesseract.recognize(base64Data, "eng", {
      ...
      console.log("Actual captcha output: ",  text)
      console.log("Filtered captcha output: ", newText)

      if(newText.length <= 4) {
        newText = '0' + newText
      }
      
      console.log("Processed captcha output: ", newText);
      const captchaInputElement = document.querySelector("#captchaTxt");
